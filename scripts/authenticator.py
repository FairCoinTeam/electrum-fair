...
imp.load_module('electrum_fair', *imp.find_module('lib'))
...
from electrum_fair.bitcoin import base_encode, base_decode
...
class Authenticator:
    ...
    def __init__(self):
        global wallet
        self.qr_data = None
        storage = WalletStorage('/sdcard/electrum-fair/authenticator')
