...
from electrum_fair import Wallet, Wallet_2of2, Wallet_2of3
...
MSG_ENTER_ANYTHING    = _("Please enter a wallet seed, a master public key, a list of FairCoin addresses, or a list of private keys")
...
class InstallWizard(QDialog):
    ...
    def __init__(self, config, network, storage, app):
        ...
        self.setWindowTitle('Electrum for FairCoin' + '  -  ' + os.path.basename(self.storage.path))
