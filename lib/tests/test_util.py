...
class TestUtil(unittest.TestCase):
    ...
    def test_parse_URI_address_amount(self):
        self._do_test_parse_URI('faircoin:fairVs8iHyLzgHQrdxb9j6hR4WGpdDbKN3?amount=0.03',
                                {'address': 'fairVs8iHyLzgHQrdxb9j6hR4WGpdDbKN3', 'amount': 30000})
    ...
    def test_parse_URI_multiple_args(self):
        self._do_test_parse_URI('faircoin:fairVs8iHyLzgHQrdxb9j6hR4WGpdDbKN3?amount=0.004&label=electrum-test&message=electrum%20test&test=none&r=http://domain.tld/page',
    ...
    def test_parse_URI_invalid(self):
        self.assertRaises(BaseException, parse_URI, 'notbitcoin:fairVs8iHyLzgHQrdxb9j6hR4WGpdDbKN3')
